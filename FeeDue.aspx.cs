...
namespace school
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            que = "Select * from DueFee Where Enrollment='" + id + "' ";
